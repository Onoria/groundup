  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#111827] to-[#1e293b] text-white relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-8 pt-16 text-center">
        ...
        {/* 3 cards — horizontal on desktop, vertical on mobile, perfectly centered */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto justify-items-center">
          {[
            ...
            <div key={step.n} className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-10 text-center shadow-2xl w-full max-w-sm">
